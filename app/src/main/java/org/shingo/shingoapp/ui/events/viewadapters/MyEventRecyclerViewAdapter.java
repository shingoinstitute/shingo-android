...
import org.shingo.shingoapp.ui.events.EventFragment.OnEventFragmentInteractionListener;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link SEvent} and makes a call to the
 * specified {@link OnEventFragmentInteractionListener}.
 *
 */
public class MyEventRecyclerViewAdapter extends RecyclerView.Adapter<MyEventRecyclerViewAdapter.ViewHolder> {

    private final List<SEvent> mValues;
    private final OnEventFragmentInteractionListener mListener;

    public MyEventRecyclerViewAdapter(List<SEvent> items, OnEventFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
