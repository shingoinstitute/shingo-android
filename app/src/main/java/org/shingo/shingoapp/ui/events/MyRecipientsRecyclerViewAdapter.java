...
/**
 * {@link RecyclerView.Adapter} that can display a {@link org.shingo.shingoapp.middle.SEntity.SRecipient} and makes a call to the
...
public class MyRecipientsRecyclerViewAdapter extends RecyclerView.Adapter<MyRecipientsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRecipientsRecyclerViewAdapter(List<SRecipient> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
