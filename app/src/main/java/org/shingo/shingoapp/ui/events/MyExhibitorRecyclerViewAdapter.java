...
import org.shingo.shingoapp.ui.events.ExhibitorFragment.OnListFragmentInteractionListener;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link SOrganization} and makes a call to the
...
public class MyExhibitorRecyclerViewAdapter extends RecyclerView.Adapter<MyExhibitorRecyclerViewAdapter.ViewHolder> {
    ...
    public MyExhibitorRecyclerViewAdapter(List<SOrganization> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
