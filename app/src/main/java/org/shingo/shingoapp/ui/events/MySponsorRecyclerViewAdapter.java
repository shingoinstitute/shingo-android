...
import org.shingo.shingoapp.ui.events.SponsorFragment.OnListFragmentInteractionListener;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link SSponsor} and makes a call to the
...
public class MySponsorRecyclerViewAdapter extends RecyclerView.Adapter<MySponsorRecyclerViewAdapter.ViewHolder> {
    ...
    public MySponsorRecyclerViewAdapter(List<SSponsor> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
